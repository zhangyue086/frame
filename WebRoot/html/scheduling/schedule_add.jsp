...
<div class="modal-body">
	<form id="scheduleAddForm" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="schedule.scheduleStart" type="text" id="scheduleStart"  />
				<input type="hidden" id="scheduleStationId" name="schedule.distributionStationId" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">结束时间<span class="required">*</span></label>
			<div class="controls">
				<input name="schedule.scheduleEnd" type="text" id="scheduleEnd"   />
			</div>
		</div>
	</form>
	<!-- END FORM-->
